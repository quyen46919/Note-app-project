...
function CardColumn(props) {
    ...
    const removeColumn = () => {
        deleteColumn(column.id)
            ...
            .catch(() => enqueueSnackbar('Xóa cột thất bại', { variant: 'error' }));
    };
    ...
    const removeCard = (cardId) => {
        deleteCard(cardId)
            ...
            .catch(() => enqueueSnackbar('xóa ghi chú thất bại', { variant: 'error' }));
    };
    ...
    const handleColumnTitleBlur = () => {
        updateColumn(column.id, { title: columnTitle })
            ...
            .catch(() => enqueueSnackbar('Cập nhật tiêu đề thất bại', { variant: 'error' }));
    };
    ...
    const handleFavoriteStarClick = () => {
        updateColumn(column.id, { isFavorite: !isFavorite })
            ...
            .catch(() => enqueueSnackbar('Cập nhật cột yêu thích thất bại', { variant: 'error' }));
    };
